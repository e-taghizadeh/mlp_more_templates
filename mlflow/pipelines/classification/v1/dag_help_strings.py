  ...
  evaluate:
    validation_criteria:
      ...
      - metric: f1_score
        threshold: 0.6
  register:
    model_name: "survival_rate_prediction_cardiovascular"
...
steps:
  predict:
    model_uri: "models:/survival_rate_prediction_cardiovascular/Production"
